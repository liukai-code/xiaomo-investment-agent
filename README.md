<div align="center">
  <img src="docs/pic/logo.png" alt="小墨 Logo" width="120">
...
小墨是一个基于 Spring AI 构建的金融投资 AI 助手，通过 Tool Calling、Workflow 和多源金融数据，实现自然语言驱动的数据查询与投资分析。
